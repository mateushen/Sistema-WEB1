...
CREATE TABLE IF NOT EXISTS `sistema`.`Cliente` (
  ...
  UNIQUE INDEX `celular_UNIQUE` (`telefone` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sistema`.`Funcionario` (
  ...
  UNIQUE INDEX `cpf_UNIQUE` (`cpf` ASC) ,
  UNIQUE INDEX `email_UNIQUE` (`email` ASC) ,
  INDEX `fk_Funcionario_Gerente1_idx` (`idGerente` ASC) ,
...
CREATE TABLE IF NOT EXISTS `sistema`.`Pagamento` (
  ...
  UNIQUE INDEX `tipo_pagamento_UNIQUE` (`tipo_pagamento` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sistema`.`Venda` (
  ...
  INDEX `fk_Venda_Veiculo1_idx` (`idVeiculo` ASC) ,
  INDEX `fk_Venda_Funcionario1_idx` (`idFuncionario` ASC) ,
  INDEX `fk_Venda_Pagamento1_idx` (`idPagamento` ASC) ,
